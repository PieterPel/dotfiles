  ...
  flake.modules.homeModules.sketchybar = { config, lib, pkgs, ... }:
    ...
    in
    {
      ...
      config = lib.mkIf (cfg.enable && pkgs.stdenv.isDarwin) {
        home = {
          file.".config/sketchybar/sketchybarrc".text = ''
          ...
          file.".config/sketchybar/plugins/aerospace.sh".text = ''
            #!/usr/bin/env bash
          ...
          activation.makeSketchyPluginsExecutable = lib.hm.dag.entryAfter [ "writeBoundary" ] ''
